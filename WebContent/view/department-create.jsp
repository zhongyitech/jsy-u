...
<link rel="stylesheet" type="text/css" href="./department-create.css">
<script type="text/javascript" src="./department-create.js"></script>
<title>新增部门</title>
</head>
	...
	<div id="page-wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div id="page-content" class="page-view pad25T">
				...
				<div class="content-box box-toggle view-width" id="department-view">
