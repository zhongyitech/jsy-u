...
<link rel="stylesheet" type="text/css" href="./customer-edit.css">
<script type="text/javascript" src="./customer-edit.js"></script>
<title>编辑客户信息</title>
</head>
	...
	<div id="page-wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div id="page-content" class="page-view pad25T">
				...
				<div class="content-box box-toggle view-width" id="customer-view">
							...
							<div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-input col-md-10">
                                            <input placeholder="请输入身份证地址" type="text" id="sfzdz">
                                        </div>
                                    </div>
