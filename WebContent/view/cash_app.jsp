...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./cash_app.css"></link>
</head>
<body class="jsy-body">
<div id="page-wrapper">
	<jsp:include page="./navi.jsp"></jsp:include>
	<script type="text/javascript" src="./cash_app.js"></script>
		...
		<div id="page-content" class="page-view pad25T">
			...
			<div class="content-box box-toggle view-width">
						...
						<div class="keyword-input-width float-left">
							<div class="form-input">
								<div class="form-input-icon">
									...
									<input type="text" placeholder="关键字搜索..." class="radius-top-left-100 radius-bottom-left-100 keyword-input" id="filter-keyword" />
								</div>
							</div>
						</div>
				...
				<div class="button-pane">
					<button type="button" class="btn-ui btn bg-green large medium float-right mrg10L" id="submit_cash"><span class="button-content">兑付申请</span></button>
				</div>
			</div>
