...
<link rel="stylesheet" type="text/css" href="./investment-print.css">
<script type="text/javascript" src="./investment-print.js"></script>
<title>打印投资确认书</title>
</head>
				...
				<div class="content-box box-toggle view-width">
					...
					<div class="content-box-wrapper">
						...
						<table class="table table-striped text-center mrg0B" id="investment-table">
							<thead>
								<tr>
									<th><span class="text-overflow"><input type="checkbox" name="checkbox"></span></th>
					...
					<div class="button-pane">
						<button class="btn-ui btn bg-green large medium float-right mrg10L" id="print-button"><span class="button-content">打印选择的确认书</span></button>
					</div>
				</div>
