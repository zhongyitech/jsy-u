...
<link rel="stylesheet" type="text/css" href="./authority-edit.css">
<script type="text/javascript" src="./authority-edit.js"></script>
<title>编辑权限</title>
</head>
	...
	<div id="page-wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div id="page-content" class="page-view pad25T">
				...
				<div class="content-box box-toggle view-width" id="investment-view">
					<div class="content-box-header primary-bg">
