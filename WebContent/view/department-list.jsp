...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./department-list.css">
	<script type="text/javascript" src="./department-list.js"></script>
	<title>部门管理</title>
</head>
	...
	<div id="page-wrapper">
		...
		<div id="page-content-wrapper">
			<div id="page-content" class="page-view pad25T">
				...
				<div class="content-box box-toggle view-width" id="department-list">
