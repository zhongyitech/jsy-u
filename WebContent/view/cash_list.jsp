		...
		<div id="page-content" class="page-view pad25T">
			...
			<div class="content-box box-toggle ">
				...
				<div class="content-box-header primary-bg">
					...
					<div class="keyword-view float-right">
						...
						<button class="btn large medium float-left keyword-button radius-top-right-100 radius-bottom-right-100" id="filter-button"><span class="button-content">搜索</span></button>
					</div>
			...
			<div class="content-box box-toggle ">
				...
				<div class="button-pane">
					<button type="button" class="btn-ui btn bg-green large medium float-right mrg10L" id="cash-add"><span class="button-content">申请付款</span></button>
				</div>
			</div>
