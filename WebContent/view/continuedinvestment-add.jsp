...
<link rel="stylesheet" type="text/css" href="./continuedinvestment-add.css"></link>
<script type="text/javascript" src="EnumCommon.js"></script>
	<script type="text/javascript" src="./continuedinvestment-add.js"></script>
<title>续投申请表</title>
</head>
...
<body class="jsy-body">
	...
	<div id="page-content-wrapper">
		...
		<div id="page-content" style="width:800px	">
			...
			<a href="./invest-list.jsp" class=" btn medium bg-gray tooltip-button" title="" data-placement="top" data-original-title="客户投资档案管理">
			...
			<form class="form-bordered "  id="form_id" action="/" method="post">
				...
				<div class="form-row">
					...
					<div class="form-label col-md-4">
						<label class="label-info bind" id="lab_fundstaus" data-bindtype="value" data-member="fund_status" ></label>
					</div>
				</div>
				<div class="form-row">
					<div class="form-label col-md-12">
				...
				<div class="form-row">
					...
					<div class="form-input col-md-3">
					<input id="xt_bje"  class="bind" data-xttypes="5" data-bindtype="value" data-member="tzje" value="0" />
					</div>
				</div>
				...
				<div class="form-row" id="">
					...
					<div class="form-input col-md-3">
						<input id="xt_sy_amount" class="" data-xttypes="2,4" data-bindtype="value" data-member="ysye" value="0"/>
					</div>
				</div>
				<div class="form-row">
					<div class="form-label col-md-3   ">
					...
					<div class="form-input col-md-3">
						<select disabled="disabled" id="xt_tzqx"><option value=1>1年</option></select>
					</div>
					<div class="form-label col-md-3  ">
