...
<link rel="stylesheet" type="text/css"
	href="./bankingTransportation.css"></link>
<script type="text/javascript" src="./bankingTransportation.js"></script>
								...
								<td>
									<div class="dropdown">
										...
										<ul class="dropdown-menu float-right">
											<li><a href="javascript:;" title=""><i class="glyph-icon icon-calendar mrg5R"></i>打印委托协议</a></li>
											<li class="divider"></li>
											<li><a href="javascript:;" title=""><i class="glyph-icon icon-calendar mrg5R"></i>作废申请单</a></li>
										</ul>
									</div>
								</td>
							</tr>
