...
<link rel="stylesheet" type="text/css" href="./refund_add.css"></link>
	<script type="text/javascript" src="./refund_add.js"></script>
<title>退伙处理申请表</title>
		...
		<div id="page-content" style="width: 800px">
			...
			<form class="form-bordered " action="/" method="post">
				...
				<div class="form-row">
					...
					<div class="form-input col-md-3">
						<input disabled="disabled" class="bind"  id="input_kcwyjbl" data-bindtype="value" data-member="kcwyjbl" data-format="rate" />
					</div>
					<div class="form-label col-md-3  ">
						<label for="" id="lab-ttype">扣除违约金金额： </label>
					</div>
					<div class="form-label col-md-3">
							<label class="bind" id="wyamount" data-bindtype="value" data-member="wyamount" data-format="money"></label>
					</div>
				</div>
