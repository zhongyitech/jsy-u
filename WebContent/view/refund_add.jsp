    ...
    <div id="page-content-wrapper">
        ...
        <div id="page-content" style="width: 800px">
            ...
            <form class="form-bordered " action="/" method="post">
                ...
                <div class="form-row">
                    <div class="form-label col-md-12">
                        <label class="font-size-18">3.退伙情况说明 </label>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-label col-md-4">
                        <label class="label-info bind" id="paysy_amount"
                ...
                <div class="form-row">
                    ...
                    <div class="form-label col-md-3">
                        <label class="label-success bind" id="gltc_amount"
                ...
                <div class="form-row">
                    <div class="form-label col-md-12">
                        <label class="font-size-18">4.收款账户信息 </label>
                    </div>
                </div>
