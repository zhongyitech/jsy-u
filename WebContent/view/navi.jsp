		...
		<ul>
			<li>
				...
				<ul>
					...
					<li>
						<a href="./hetong-lingyong.jsp" title="合同领用"><i class="glyph-icon icon-chevron-right"></i>合同领用</a>
					</li>
					
					<li>
						<a href="./hetong-guihuan.jsp" title="合同归还"><i class="glyph-icon icon-chevron-right"></i>合同归还</a>
					</li>
				</ul>
			<li>
				<a href="javascript:;" title="客户管理"><i class="glyph-icon icon-reorder"></i>客户管理</a>
				<ul>
					<li><a href="invest-list.jsp" title="客户档案管理"><i class="glyph-icon icon-chevron-right"></i>客户投资档案管理</a></li>
					<li><a href="./investment.jsp" title="添加投资档案"><i class="glyph-icon icon-chevron-right"></i>添加投资档案</a></li>
					<li><a href="./investment-print.jsp" title="打印投资确认书"><i class="glyph-icon icon-chevron-right"></i>打印投资确认书</a></li>
					<li><a href="./customer-list.jsp" title="客户信息修改"><i class="glyph-icon icon-chevron-right"></i>客户信息修改</a></li>
					<li><a href="commission_query.jsp" title="提成申请"><i class="glyph-icon icon-chevron-right"></i>提成查询</a></li>
					<li><a href="commission_apply.jsp" title="提成申请"><i class="glyph-icon icon-chevron-right"></i>提成申请</a></li>
					<li><a href="./cash_app.jsp" title="兑付查询"><i class="glyph-icon icon-chevron-right"></i>兑付查询</a></li>
					<li><a href="./cash_list.jsp" title="兑付申请"><i class="glyph-icon icon-chevron-right"></i>兑付申请</a></li>
					<li><a href="./czjlrz-list.jsp" title="操作记录日志"><i class="glyph-icon icon-chevron-right"></i>操作记录日志</a></li>
				</ul>
			</li>
			...
			<li>
				...
				<ul>
					<li><a href="new_project.jsp" title="新建项目"><i class="glyph-icon icon-chevron-right"></i>新建项目</a></li>
					<li><a href="project_list.jsp" title="项目列表"><i class="glyph-icon icon-chevron-right"></i>项目列表</a></li>
					<li><a href="new_pay_record.jsp" title="新增汇款记录"><i class="glyph-icon icon-chevron-right"></i>新增汇款记录</a></li>
					<li><a href="new_receive_record.jsp" title="新增收款记录"> <i class="glyph-icon icon-chevron-right"></i>新增收款记录</a></li>
					<li><a href="pay_record_list.jsp" title="项目转款明细表"> <i class="glyph-icon icon-chevron-right"></i>项目转款明细表</a></li>
					<li><a href="end_project.jsp" title="项目结算"><i class="glyph-icon icon-chevron-right"></i>项目结算</a></li>
				</ul>
			</li>
