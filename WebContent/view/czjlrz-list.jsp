...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./czjlrz-list.css">
	<script type="text/javascript" src="./czjlrz-list.js"></script>
	<title>操作记录日志</title>
</head>
	...
	<div id="page-wrapper">
		...
		<div id="page-content-wrapper">
			<div id="page-content" class="page-view pad25T">
				...
				<div class="content-box box-toggle view-width" id="czjlrz-list">
					<div class="content-box-header primary-bg">
						<span class="float-left">操作记录日志</span>
						
						<a href="#" class="float-right icon-separator btn toggle-button" title="操作记录日志">
