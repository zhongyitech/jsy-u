            ...
            <form class="form-bordered " action="/" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-3">
                        <input class="bind" data-bindtype="value" data-member="wyamount"
                               data-format="money" id="wy_amount"/>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-3">
                        <input class=" label-info bind" id="ywtc"
                               data-bindtype="value" data-member="ywtc" data-format="rate"/>
                    </div>
                    <div class="form-label col-md-3  ">
                        <label id="lab-ttype">金额： </label>
                    </div>
                    <div class="form-input col-md-3">
                        <input class="label-success bind"
                               data-bindtype="value" data-member="ywtc_amount"
                               data-format="money" id="ywtc_amount">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-3">
                        <input class="  bind" id="gltc"
                               data-bindtype="value" data-member="gltc" data-format="rate"/>
                    </div>
                    <div class="form-label col-md-3  ">
                        <label id="lab-ttype">金额：</label>
                    </div>
                    <div class="form-input col-md-3">
                        <input class="label-success bind"
                               ...
                               data-format="money" id="gltc_amount"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-label col-md-12">
