...
<link rel="stylesheet" type="text/css" href="./company-edit.css">
<script type="text/javascript" src="./company-edit.js"></script>
<title>编辑公司信息</title>
</head>
	...
	<div id="page-wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div id="page-content" class="page-view pad25T">
				...
				<div class="content-box box-toggle view-width" id="company-view">
					<div class="content-box-header primary-bg">
						<span class="float-left">编辑公司信息</span>
								...
								<div class="form-label col-md-2">
                                    <label for="" class="label-description" id="partner-label">合伙人:</label>
                                 	...
                                 	<div class="input-append-wrapper input-append-right">
                                 		<div class="input-append bg-green pointer disabled" id="partner-button"><i class="glyph-icon icon-edit"></i></div>
					...
					<div class="button-pane" id="menu">
						...
						<button class="btn-ui btn bg-green large medium float-right mrg10L partner-button hide" id="partner-button"><span class="button-content">合伙人</span></button>
					</div>
				</div>
			...
			<div class="hide" id="partner-dialog" title="合伙人">
				...
				<div class="content-box box-toggle view-width" id="yhzh-view">
