...
var COMPANY_LIST = {
    ...
    set: function () {
        ...
        var data = {
            url: '/api/fundCompanyInformation/readAllForPage', params: {}, entity: {
...
var s = {
    "rest_result": [{
        "class": "com.jsy.bankConfig.BankOrderEntry",
        "id": 1,
        "borrowAmount": 300000.00,
        "company": "深圳金赛银基金管理有限公司",
        "createDate": "2015/04/16 11:00:45",
        "evidenceCode": null,
        "lendAmount": 0.00,
        "manageType": 0,
        "subjectName": "其它应付款-深圳金赛银基金管理有限公司",
        "summary": "深圳金赛银基金管理有限公司往来款",
        "transaction": "0000002"
    }], "rest_status": "suc"
}
