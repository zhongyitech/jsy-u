...
var VIEWDATA = {
        ...
        save: function () {
            ...
            var postData = {
                ...
                kcwyjbl: 0,
                kcwyj: MONEYFORMAT.toNumber($("#wy_amount").val()),

                yqsye: this.item.ysye,
                ydyqsyl: this.item.nhsyl,
                ywtchsbl: RATEFORMAT.toNumber($("#ywtc").val()),
                ywtchsje: MONEYFORMAT.toNumber($("#ywtc_amount").val()),
                gltchsbl: RATEFORMAT.toNumber($("#gltc").val()),
                gltchsje: MONEYFORMAT.toNumber($("#gltc_amount").val()),
