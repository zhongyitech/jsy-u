...
var HTLY_PUT = {
		...
		put: function(item){
			...
			var data = {url: '/api/registerContract/returnContract', params: params, entity: entity};
...
var HTLY_LIST ={
		...
		set: function(async){
			...
			var data = {url: '/api/registerContract/readReturnForPage', params: params, entity: entity};
